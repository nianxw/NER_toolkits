...
def collate_fn(data):
    ...
    for i in range(len(examples)):
        ...
        batch_input_segment_ids.append(example['segment_ids'])
    ...
    batch_input_segment_ids = torch.tensor(np.array(batch_input_segment_ids)[:, : max_len], dtype=torch.long)
    ...
    return batch_input_ids, batch_input_mask, batch_input_segment_ids, batch_label_ids, batch_input_len, batch_text_ids, batch_sentence
