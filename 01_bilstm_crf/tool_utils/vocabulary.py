...
class Vocabulary(object):
    ...
    def reset(self):
        ctrl_symbols = [self.pad_token, self.unk_token,
    ...
    def build_vocab(self):
        max_size = min(self.max_size, len(self.word_counter)
        ...
        self.word2idx.update(
            {w: i + start_idx for i, (w, _) in enumerate(words)})
    ...
    def save(self, file_path):
        ...
        pickle.dump(mappings, open(file_path, 'wb'))
    ...
    def load_from_file(self, file_path):
        ...
        :return:
        '''
        mappings = pickle.load(open(file_path, 'rb'))
